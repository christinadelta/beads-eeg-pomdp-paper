...
%% 
% Either run recovery (takes long) or load recovery results and plot them
% (in line 142)
...
%% visualisation (Scatterplots; Supplementary figure 2)

% load parameter recovery results
load('costNoise_paramRec.mat')
...
%% Visualisation (Scatterplots; Supplementary figure 3)
